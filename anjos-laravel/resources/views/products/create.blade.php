...
<head>
  ...
  <title>Crear Producto - Anjos Joyería</title>
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input type="text" id="material" name="material" value="{{ old('material') }}" placeholder="Ej: Oro 18k, Plata 925">
              @error('material')
                <span class="error">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="color" name="color" value="{{ old('color') }}" placeholder="Ej: Dorado, Plateado">
              @error('color')
                <span class="error">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="finish" name="finish" value="{{ old('finish') }}" placeholder="Ej: Brillante, Mate">
              @error('finish')
                <span class="error">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="stones" name="stones" value="{{ old('stones') }}" placeholder="Ej: Diamantes, Zafiros">
              @error('stones')
                <span class="error">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="form-group">
            ...
            <select id="placement" name="placement" required>
              ...
              <option value="catalog" {{ old('placement') == 'catalog' ? 'selected' : '' }}>Solo en Catálogo</option>
              <option value="carousel" {{ old('placement') == 'carousel' ? 'selected' : '' }}>Solo en Carrusel del Inicio</option>
              <option value="home_products" {{ old('placement') == 'home_products' ? 'selected' : '' }}>Solo en Productos del Inicio</option>
              <option value="all" {{ old('placement') == 'all' ? 'selected' : '' }}>En Todas las Secciones</option>
            </select>
            @error('placement')
              <span class="error">{{ $message }}</span>
            @enderror
